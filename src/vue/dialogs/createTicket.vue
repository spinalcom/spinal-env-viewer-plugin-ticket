   ...
   >
            ...
            <div class="content details">
               ...
               <div class="left">
                  ...
                  >
                     ...
                     <div
                        class="value"
                        v-tooltip="commonTicketInfo.name"
                     >{{commonTicketInfo.name}}</div>
                  </div>
      ...
      <md-dialog-actions>
         ...
         <md-button
            class="md-primary"
            @click="createTicket"
            :disabled="!(ticket.name.trim().length > 0)"
         >Save</md-button>
      </md-dialog-actions>
...
export default {
   ...
   methods: {
      ...
      //          let files = FileExplorer.addFileUpload(data.directory, [
      //             data.file,
      //          ]);
